...
if args.print == "file":
    sys.stdout = open(f"cifar_outputs/{args.transform}_{args.num_tasks}_{int(args.increment)}_{args.start}_{args.end}_{args.samples}.txt", "w")
...
torch.save(data_tensor, f"cifar_results/{args.dataset}_{args.transform}_{args.num_tasks}_{int(args.increment)}_{args.start}_{args.end}_{args.samples}.pt")
